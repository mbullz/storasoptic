...
<script language="javascript" type="text/javascript">
	...
	{	
		...
		if (i % 5 == 0)
		{
			...
			{
				html += "<td width='20%' align='center' style='font-size:10px'>" + company_name + "<br><font style='font-family:fontBarcode;font-size:18px;'>*" + i + "*</font><br>" + data[i+1] + "<br>" + data[i+2] + "<br>" + data[i+3] + " / " + data[i+4] + "</td>";
			}
			else html += "<td>&nbsp;</td>";
		}
