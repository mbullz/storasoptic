<?php
	...
	switch($mode) {
		case 'general_report':
			...
			$query = "select a.id, a.tgl, a.referensi, a.jumlah, a.info, b.matauang, d.pembayaran "
					. "from aruskas a "
					. "join matauang b on a.matauang = b.kode "
					. "join carabayar d on a.carabayar_id = d.carabayar_id "
					. "where a.tipe='operasional' and a.tgl >= '$startDate' and a.tgl <= '$endDate'";
			$res = $mysqli->query($query);
			
			$field_name = array('Tanggal', 'Pembayaran', 'No. Ref', 'Jumlah', 'Info');
