...
// cara bayar
$query_cbyr = "select kode, pembayaran from carabayar where tipe <>'Pembelian' order by pembayaran";
$cbyr       = $mysqli->query($query_cbyr);
$row_cbyr   = mysqli_fetch_assoc($cbyr);
$total_cbyr = mysqli_num_rows($cbyr);
// get jumlah hutang
$query_ghut = "select total from keluarbarang where referensi='$row_edit[referensi]'";
