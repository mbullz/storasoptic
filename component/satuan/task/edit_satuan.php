...
$id = $_GET['id'];
// query edit
$query_edit = "select * from satuan where kode='$id'";
...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="edit" id="edit">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      <td align="right" valign="top">Satuan *</td>
      <td align="center" valign="top">:</td>
      <td valign="top"><label>
        <input name="satuan" type="text" id="satuan" value="<?php echo $row_edit['satuan'];?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
