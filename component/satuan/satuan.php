...
//---- filter data
if($q <>'') {
	$query_data .= " where kode LIKE '%$q%' OR satuan LIKE '%$q%'";	
	$query_all  .= " where kode LIKE '%$q%' OR satuan LIKE '%$q%'";
}
//----
  ...
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <tr valign="top">
        ...
        <td align="left"><?php echo $row_data['satuan'];?></td>
	  ...
	  <tr>
        ...
        </label><a href="export_xls.php?tabel=satuan" title="Export Data XLS"><img src="images/_xls.png" width="20" height="20" border="0" align="right" /></a></td>
      </tr>
      <?php } ?>
      <tr>
