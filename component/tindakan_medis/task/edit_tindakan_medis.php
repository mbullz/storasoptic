...
$id = $_GET['id'];
// query edit
$query_edit = "select * from hos_tmedis where kode='$id'";
...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="edit" id="edit">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      ...
      <td valign="top"><label>
        <input name="kode" type="text" id="kode" onfocus="this.blur();" value="<?php echo $row_edit['kode'];?>" size="8" maxlength="5"/>
      </label></td>
    </tr>
    <tr>
      <td align="right" valign="top">Tindakan Medis *</td>
      <td align="center" valign="top">:</td>
      <td valign="top"><label>
        <input name="tmedis" type="text" id="tmedis" value="<?php echo $row_edit['tmedis'];?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
      ...
      <td align="center">:</td>
      <td><label>
        <input name="biaya" type="text" id="biaya" value="<?php echo $row_edit['biaya'];?>" size="8" maxlength="11" />
      </label></td>
    </tr>
    <tr valign="top">
      ...
      <td align="center">:</td>
      <td><label>
        <textarea name="info" id="info" cols="75" rows="5"><?php echo $row_edit['info'];?></textarea>
      </label></td>
    </tr>
    <tr>
