...
$id = $_GET['id'];
// query edit
$query_edit = "select * from divisi where kode='$id'";
...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="edit" id="edit">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      <td align="right" valign="top">Divisi *</td>
      <td align="center" valign="top">:</td>
      <td valign="top"><label>
        <input name="divisi" type="text" id="divisi" value="<?php echo $row_edit['divisi'];?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
