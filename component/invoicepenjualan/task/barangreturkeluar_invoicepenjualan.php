...
<h1>Retur Pengiriman Barang Baru</h1> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      ...
      <td width="82%" valign="top"><label>
        <input name="invoice" type="text" id="invoice" value="<?php echo $row_edit['noreferensi'];?>" size="20" maxlength="20" onfocus="this.blur();">
      </label></td>
    </tr>
    <tr>
    ...
    <tr valign="top">
      ...
      <td align="center">:</td>
      <td><?php if ($row_edit['kode'] != "") echo $row_edit['kode'] . " # ";?><?php echo $row_edit['jenis'];?> # <?php echo $row_edit['barang'];?> # <?php echo $row_edit['color'];?><label>
