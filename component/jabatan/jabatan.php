...
$query_data  = "select * from hos_jabatan";
//----
$query_all   = $query_data;
//---- filter data
if($q <>'') {
	$query_data .= " where kode LIKE '%$q%' OR jabatan LIKE '%$q%'";	
	$query_all  .= " where kode LIKE '%$q%' OR jabatan LIKE '%$q%'";
}
//----
  ...
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <tr valign="top">
        ...
        <td align="left"><?php echo $row_data['jabatan'];?></td>
