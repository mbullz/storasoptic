...
$query_data  = "select a.id, a.qty, b.gudang, c.kode, c.barang, d.satuan, e.jenis from stokbarang a, gudang b, barang c, satuan d, jenisbarang e where a.gudang =  b.kode AND a.barang = c.kode AND a.satuan = d.satuan AND c.jenis = e.kode";
//----
$query_all   = $query_data;
//---- filter data
if($q <>'') {
	$query_data .= " where kode LIKE '%$q%' OR jenis LIKE '%$q%' OR klasifikasi LIKE '%$q%'";	
	$query_all  .= " where kode LIKE '%$q%' OR jenis LIKE '%$q%' OR klasifikasi LIKE '%$q%'";
}
//----
$query_data .= " order by b.gudang, e.jenis, c.kode limit $b offset $bp";
...
<form id="formdata" name="formdata" method="post" action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=mdelete">
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr valign="top">
        <td colspan="6" align="right"><a href="index-c-<?php echo $c;?>-t-add-k-importcsv.pos" title="Import CSV"><img src="images/_xls.png" width="20" height="20" border="0" align="left" /></a><label>
      ...
      <tr valign="top">
        ...
        <td align="center"><?php echo $row_data['gudang'];?></td>
        <td align="left"><?php echo ucfirst($row_data['jenis']);?> | <?php echo ucfirst($row_data['kode']);?> - <?php echo ucfirst($row_data['barang']);?></td>
        <td align="left"><?php echo $row_data['qty'];?> <?php echo $row_data['satuan'];?></td>
	  ...
	  <tr>
        ...
        </label> <a href="export_xls.php?tabel=stokbarang" title="Export Data XLS"><img src="images/_xls.png" width="20" height="20" border="0" align="right" /></a></td>
      </tr>
      <?php } ?>
      <tr>
