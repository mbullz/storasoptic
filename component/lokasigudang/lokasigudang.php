...
$query_data  = "select * from gudang";
//----
$query_all   = $query_data;
//---- filter data
if($q <>'') {
	$query_data .= " where kode LIKE '%$q%' OR gudang LIKE '%$q%'";	
	$query_all  .= " where kode LIKE '%$q%' OR gudang LIKE '%$q%'";
}
//----
...
<form id="formdata" name="formdata" method="post" action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=mdelete">
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr valign="top">
        <td colspan="2"><?php if(strstr($_SESSION['akses'],"add_".$c)) { ?><a href="index-c-<?php echo $c;?>-t-add.pos"><img src="images/add.png" border="0"/>&nbsp;Tambah Data</a> <a href="index-c-<?php echo $c;?>-t-add-k-importcsv.pos" title="Import CSV"><img src="images/_xls.png" width="20" height="20" border="0" align="right" /></a><?php } ?></td>
      ...
      <tr valign="top">
        ...
        <td align="left"><?php echo $row_data['gudang'];?></td>
	  ...
	  <tr>
        ...
        </label><a href="export_xls.php?tabel=gudang" title="Export Data XLS"><img src="images/_xls.png" width="20" height="20" border="0" align="right" /></a></td>
      </tr>
      <?php } ?>
      <tr>
