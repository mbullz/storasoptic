...
$id = $_GET['id'];
// query edit
$query_edit = "SELECT user_id, pass, akses 
				FROM kontak 
				WHERE user_id = $id ";
...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="edit" id="edit">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      ...
      <td width="82%" valign="top"><label>
        ...
        <select name="nik" id="nik">
          ...
          <?php do { ?>
          <option value="<?php echo $row_kar['kode'];?>" <?php if($row_kar['kode']==$row_edit['kode']) { ?>selected="selected"<?php } ?>><?php echo $row_kar['kode'];?> - <?php echo $row_kar['kontak'];?></option>
    ...
    <tr>
      ...
      <td valign="top"><label>
        <input name="password" type="password" id="password" value="<?php echo $row_edit['pass'];?>" size="20" maxlength="30" />
      </label></td>
    </tr>
    <tr>
...
Detail Data <br />
  ...
  <label>
    <input name="per[]" type="checkbox" id="per[]" value="delete_pembayaranhutang" <?php if(strstr($row_edit['akses'],'delete_pembayaranhutang')) { ?>checked="checked"<?php } ?>/>
          ...
          <tr>
            <td valign="top"><label>
              <input name="per[]" type="checkbox" id="per[]" value="piutangjtempo" <?php if(strstr($row_edit['akses'],'piutangjtempo')) { ?>checked="checked"<?php } ?>/>
            </label>
              Piutang Jatuh Tempo <br />
  <label>
    <input name="per[]" type="checkbox" id="per[]" value="pembayaranpiutang" <?php if(strstr($row_edit['akses'],'pembayaranpiutang')) { ?>checked="checked"<?php } ?>/>
  </label>
  ...
  <label>
    <input name="per[]" type="checkbox" id="per[]" value="delete_cbayar" <?php if(strstr($row_edit['akses'],'delete_cbayar')) { ?>checked="checked"<?php } ?>/>
              ...
              Delete Data </td>
            <td valign="top"><label>
              <input name="per[]" type="checkbox" id="per[]" value="reportjualper_pm" <?php if(strstr($row_edit['akses'],'reportjualper_pm')) { ?>checked="checked"<?php } ?>/>
              </label>
              Penjualan per Sales<br />
              <label>
                <input name="per[]" type="checkbox" id="per[]" value="reportjualper_customer" <?php if(strstr($row_edit['akses'],'reportjualper_customer')) { ?>checked="checked"<?php } ?>/>
                </label>
              Penjualan per Customer<br />
              <label>
                <input name="per[]" type="checkbox" id="per[]" value="reportjualper_barang" <?php if(strstr($row_edit['akses'],'reportjualper_barang')) { ?>checked="checked"<?php } ?>/>
                </label>
              Penjualan per Barang<br />
              <label>
                <input name="per[]" type="checkbox" id="per[]3" value="reportrugilaba" <?php if(strstr($row_edit['akses'],'reportrugilaba')) { ?>checked="checked"<?php } ?>/>
                </label>
              Rugi Laba Perusahaan</td>
            </tr>
        </table>
      </div></td>
    </tr>
