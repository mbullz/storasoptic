...
$id = $_GET['id'];
// query edit
$query_edit = "select a.id,a.noreferensi,a.tgl,a.qty,a.info,b.kode,b.barang,c.gudang,d.satuan,e.id as stokid,e.qty as stok from terimabarang a, barang b, gudang c, satuan d, stokbarang e where a.barang = b.kode AND a.gudang = c.kode AND a.satuan = d.kode AND a.barang = e.barang AND a.gudang = e.gudang AND a.satuan = e.satuan AND a.id='$id'";
