...
$query_data  = "select a.id, a.tgl, a.noreferensi, a.qty, a.info, b.barang, h.jenis, c.gudang, d.satuan, f.kontak from terimabarang a join barang b on a.barang = b.kode join gudang c on a.gudang = c.kode join satuan d on a.satuan = d.kode join masukbarang e on a.noreferensi=e.referensi join kontak f on e.supplier=f.kode join jeniskontak g on f.jenis=g.kode join jenisbarang h on b.jenis=h.kode where g.klasifikasi='supplier' ";
//----
  ...
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <tr valign="top">
		...
		<td align="center"><?php echo $row_data['kontak']; ?></td>
	  ...
	  <tr>
        ...
        </label><a href="export_xls.php?tabel=terimabarang" title="Export Data XLS"><img src="images/_xls.png" width="20" height="20" border="0" align="right" /></a></td>
      </tr>
      <?php } ?>
      <tr>
