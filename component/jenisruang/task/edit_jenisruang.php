...
$id = $_GET['id'];
// query edit
$query_edit = "select * from hos_jruang where kode='$id'";
...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="edit" id="edit">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      <td align="right" valign="top">Tipe Ruang Medis*</td>
      <td align="center" valign="top">:</td>
      <td valign="top"><label>
        <input name="truang" type="text" id="truang" value="<?php echo $row_edit['jenis'];?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
