...
$query_data  = "select * from hos_jruang";
//----
$query_all   = $query_data;
//---- filter data
if($q <>'') {
	$query_data .= " where kode LIKE '%$q%' OR jenis LIKE '%$q%'";	
	$query_all  .= " where kode LIKE '%$q%' OR jenis LIKE '%$q%'";
}
//----
  ...
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <tr>
        ...
        <th width="12%">Kode</th>
        <th width="28%">Tipe Ruang Medis</th>
        <th>Info</th>
