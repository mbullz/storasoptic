...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="add" id="add">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      ...
      <td valign="top"><label>
          <input name="klasifikasi" type="radio" id="klasifikasi_0" value="sales" checked="checked" />
          Sales</label>
        <label>
          <input type="radio" name="klasifikasi" value="karyawan" id="klasifikasi_1" />
        Karyawan</label>
        <label>
          <input type="radio" name="klasifikasi" value="customer" id="klasifikasi_2" />
        Customer</label>
        <label>
          <input type="radio" name="klasifikasi" value="supplier" id="klasifikasi_3" />
      Supplier</label></td>
    </tr>
    <tr>
      <td align="right" valign="top">Jenis Kontak *</td>
      <td align="center" valign="top">:</td>
      <td valign="top"><label>
