...
$id = $_GET['id'];
// query edit
$query_edit = "select * from jeniskontak where kode='$id'";
...
<form action="component/<?php echo $c;?>/p_<?php echo $c;?>.php?p=<?php echo $t;?>" method="post" name="edit" id="edit">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      <td align="right" valign="top">Klasifikasi *</td>
      <td align="center" valign="top">:</td>
      <td valign="top"><label>
        <input <?php if (!(strcmp($row_edit['klasifikasi'],"sales"))) {echo "checked=\"checked\"";} ?> name="klasifikasi" type="radio" id="klasifikasi_0" value="sales" />
        Sales</label>
        <label>
          <input <?php if (!(strcmp($row_edit['klasifikasi'],"karyawan"))) {echo "checked=\"checked\"";} ?> type="radio" name="klasifikasi" value="karyawan" id="klasifikasi_1" />
          Karyawan</label>
        <label>
          <input <?php if (!(strcmp($row_edit['klasifikasi'],"customer"))) {echo "checked=\"checked\"";} ?> type="radio" name="klasifikasi" value="customer" id="klasifikasi_2" />
          Customer</label>
        <label>
<input <?php if (!(strcmp($row_edit['klasifikasi'],"supplier"))) {echo "checked=\"checked\"";} ?> type="radio" name="klasifikasi" value="supplier" id="klasifikasi_3" />
          Supplier</label></td>
    </tr>
    <tr>
