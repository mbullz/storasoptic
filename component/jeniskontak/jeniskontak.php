...
$query_data  = "select * from jeniskontak";
//----
  ...
  <div class="tablebg">
    ...
    <table class="datatable" width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <tr valign="top">
        ...
        <td align="left"><?php echo ucfirst($row_data['klasifikasi']);?></td>
	  ...
	  <tr>
        ...
        </label><a href="export_xls.php?tabel=jeniskontak" title="Export Data XLS"><img src="images/_xls.png" width="20" height="20" border="0" align="right" /></a></td>
      </tr>
      <?php } ?>
      <tr>
